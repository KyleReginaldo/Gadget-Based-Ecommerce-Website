          ...
          <section class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    ?><div style="padding: 20px; background-color: #FFFFFF; border-radius: 15px; box-shadow: 10px 20px 30px rgba(0, 0, 0, 0.1);">
                    <div style="margin-bottom: 40px; background-color: #FFFFFF; padding: 20px; border-radius: 10px; box-shadow: 10px 20px 30px rgba(0, 0, 0, 0.1);">
