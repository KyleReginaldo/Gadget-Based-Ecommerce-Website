    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="scallout" id="scallout" style="display:none;"><span class="message">Address added successfully</span></div>
            </div>
            <div class="modal-body">
                <form class="add-new-address" id="add-new-address" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type='button' class='cancel' data-id='<?php echo $order['id']?>' $hide>Cancel</button>
