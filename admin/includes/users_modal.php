        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-1 control-label">Contact Info</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_password" class="col-sm-1 control-label">Password</label>
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-1 control-label">Firstname</label>
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-1 control-label">Lastname</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-1 control-label">Contact Info</label>
